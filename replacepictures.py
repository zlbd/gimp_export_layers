...
register(
    ...
    "RGB*, GRAY*",
    [
        (PF_DIRNAME, "string", "Directory",     s_sHome),
        (PF_RADIO,   "format", "Image Format",  "bmp", (("png", "png"), ("bmp(32-bit)", "bmp"))),
